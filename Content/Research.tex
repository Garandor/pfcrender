...
Writing portable software has always been difficult, as operating system APIs differ significantly. 

Linux and MacOS comply with the \gls{posix} standard, which governs the OS-hardware interaction \gls{api}, while Windows has historically had a non-\gls{posix}-compliant proprietary system programming \gls{api}.
...
Notable \gls{api} differences are in
\begin{description}
