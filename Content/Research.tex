...
It consists of many non-coding factors, including
\begin{itemize}
	\item ease of collaboration
	\item issue tracking
	\item enforcecment of a common coding standard, i.e. making sure code from different contributors "looks the same"
...
\subsubsection{Git}
\gls{git} is a code revisioning software implementation created by Linus Torvalds, searching for a solution to manage the growing base of coders on his main project - the Linux kernel.
