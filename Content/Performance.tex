...
do_paint, which renders using QPainter API is a factor of 10 slower than manual creation of the OpenGL Vertex/Colordata
...
\subsubsubsection{Encapsulation of Functionality (OOP) vs. Method Call overhead}
...
\subsubsubsection{Runtime Optimization}
...
\subsubsubsection{Compiler Optimizations and Inlining}
...
\subsubsubsection{Link-Time Optimization}
...
\subsubsubsection{Polymorphism and Performance}
